...
import { Bell, Users, Send, Settings } from 'lucide-react';

export function AdminNotificationsPage() {
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-3xl font-bold">Gestion Notifications</h1>
        <p className="text-muted-foreground">
          Envoi et configuration des notifications système
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-purple-600">Abonnés</p>
          </CardContent>
        </Card>
