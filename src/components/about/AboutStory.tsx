        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-4 text-gray-600">
              <p>
                Pharma Africa Connect est né d'un constat simple : dans de nombreuses régions, l'accès aux soins de santé reste un défi majeur. 
              ...
              <p>
                ...
                Pharma Africa Connect a été conçu pour répondre à ces défis en tirant parti des technologies digitales.
              </p>
              <p>
